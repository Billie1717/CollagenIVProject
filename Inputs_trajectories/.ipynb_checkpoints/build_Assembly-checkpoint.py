...
def main():
    ...
    ################ Parameters ################
    MakeDist = 0 #str(sys.argv[2])
    BreakDist = 0 # str(sys.argv[3])
    Prob = str(sys.argv[11])
    MakeProb = 1 #str(sys.argv[5])
    ...
    NumFixCycl = int(sys.argv[6])
    XStretch = float(sys.argv[7])
    K_angle = str(sys.argv[8])
    Nevery = str(sys.argv[9])
    Nevery_Cr2 = 1 #str(float(Nevery_Cr)/100)
    MakeDist2 = 1.5
    Blen=float(sys.argv[10])
    ChemBond =  float(sys.argv[11])
    Prob = str(sys.argv[12])
...
''')
    ...
    fo.write('variable trelax			equal 	'+str(trelax)+'	#NVT steps for post stretch relaxation\n')
    #fo.write('variable total			equal 	'+str(trelax+tbonds+tmix+tstretch)+'	#NVT steps for post stretch relaxation\n')
    fo.write(
        '''
...
variable ttotal     equal   $(v_tmix+v_tbonds+v_trelax+v_tstretch)		#total timesteps
...
variable trestart       equal   $(floor(v_ttotal/100))    	#Restart configuration saving period\n''')
    ...
    fo.write('variable tcycleRel   equal   $(floor((v_trelax)/'+str(10*NumFixCycl)+'))    	#Restart configuration saving period\n')
    fo.write(
        '''
...
#NC1 bond (1 per molecule)\n''')
    ...
    #fo.write('variable bond_prob_nc1	equal   '+str(MakeProb)+'				#Probability to create a bond\n')
    #fo.write('variable bond_dist_nc1  	equal 	$(v_r0_nc1*'+str(MakeDist)+') 	#Bonding distance\n')
    #fo.write('variable bond_distBreak_nc1  	equal 	$(v_r0_nc1*'+str(BreakDist)+') 	#Breaking distance\n')
    fo.write('variable prob	equal 	'+str(Prob)+'	#Breaking probability\n')
    fo.write('variable cutoff	equal 	'+str(cutoff)+'	#Breaking probability\n')
    ...
    #fo.write('variable bond_prob_7s	equal   '+str(MakeProb)+'				#Probability to create a bond\n')
    #fo.write('variable bond_dist_7s 	equal 	$(v_r0_7s*'+str(MakeDist)+')  	#Bonding distance\n')
    #fo.write('variable bond_dist_7s2 	equal 	$(v_r0_7s*'+str(MakeDist2)+')  	#Bonding distance\n')
    #fo.write('variable bond_distBreak_7s 	equal 	$(v_r0_7s*'+str(BreakDist)+')  	#Breaking distance\n')
    #fo.write('variable break_prob_7s	equal 	'+str(BreakProb)+'	#Breaking probability\n')
...
#---------------- Making bonds -----------------#
variable vrdimer equal f_freact[1]
variable vrdimer1 equal f_freact[2]
variable vrdimer2 equal f_freact[3]
variable vrdimer3 equal f_freact[4]

variable vrtrimer equal f_freact[5]
variable vrtrimer1 equal f_freact[6]
variable vrtrimer2 equal f_freact[7]
variable vrtrimer3 equal f_freact[8]
variable vrtrimer4 equal f_freact[9]
variable vrtrimer5 equal f_freact[10]
variable vrtrimer6 equal f_freact[11]
variable vrtrimer7 equal f_freact[12]
variable vrtrimer8 equal f_freact[13]
variable vrtrimer9 equal f_freact[14]
variable vrtrimer10 equal f_freact[15]
variable vrtrimer11 equal f_freact[16]
variable vrtrimer12 equal f_freact[17]
variable vrtrimer13 equal f_freact[18]

variable vrtrimerF1 equal f_freact[19]
variable vrtrimerF2 equal f_freact[20]
variable vrtrimerF3 equal f_freact[21]
variable vrtrimerF4 equal f_freact[22]
variable vrtrimerF5 equal f_freact[23]
variable vrtrimerF6 equal f_freact[24]

variable vtetramer0 equal f_freact[25]
variable vtetramer1 equal f_freact[26]
variable vtetramer2 equal f_freact[27]
variable vtetramer3 equal f_freact[28]
variable vtetramer4 equal f_freact[29]
variable vtetramer5 equal f_freact[30]
variable vtetramer6 equal f_freact[31]
variable vtetramer7 equal f_freact[32]
variable vtetramer8 equal f_freact[33]
variable vtetramer9 equal f_freact[34]
variable vtetramer10 equal f_freact[35]
variable vtetramer11 equal f_freact[36]
variable vtetramer12 equal f_freact[37]
variable vtetramer13 equal f_freact[38]
variable vtetramer14 equal f_freact[39]
variable vtetramer15 equal f_freact[40]
variable vtetramer16 equal f_freact[41]
variable vtetramer17 equal f_freact[42]
variable vtetramer18 equal f_freact[43]
variable vtetramer19 equal f_freact[44]
variable vtetramer20 equal f_freact[45]
variable vtetramer21 equal f_freact[46]
variable vtetramer22 equal f_freact[47]
variable vtetramer23 equal f_freact[48]
variable vtetramer24 equal f_freact[49]

#---------------- Breaking bonds -----------------#

variable bdimer equal f_freact[50]
variable bdimer2 equal f_freact[51]
variable bdimer6 equal f_freact[52]
variable bdimer62 equal f_freact[53]
variable bdimer4 equal f_freact[54]
variable bdimer42 equal f_freact[55]
variable bdimer5 equal f_freact[56]
variable bdimer52 equal f_freact[57]
variable bdimer7 equal f_freact[58]
variable bdimer72 equal f_freact[59]

variable bdimerA equal f_freact[60]
variable bdimerA1 equal f_freact[61]
variable bdimerA2 equal f_freact[62]
variable bdimerA3 equal f_freact[63]

variable btrimer equal f_freact[64]
variable btrimer1 equal f_freact[65]
variable btrimer2 equal f_freact[66]
variable btrimer3 equal f_freact[67]
variable btrimer4 equal f_freact[68]
variable btrimer5 equal f_freact[69]

variable btrimerF equal f_freact[70]
variable btrimerF1 equal f_freact[71]
variable btrimerF2 equal f_freact[72]
variable btrimerF3 equal f_freact[73]
variable btrimerF4 equal f_freact[74]
variable btrimerF5 equal f_freact[75]
variable btrimerF6 equal f_freact[76]
variable btrimerF7 equal f_freact[77]
variable btrimerF8 equal f_freact[78]
variable btrimerF9 equal f_freact[79]

variable btetramer equal f_freact[80]
variable btetramer1 equal f_freact[81]
variable btetramer2 equal f_freact[82]
variable btetramer3 equal f_freact[83]
variable btetramer4 equal f_freact[84]
variable btetramer5 equal f_freact[85]
variable btetramer6 equal f_freact[86]
variable btetramer7 equal f_freact[87]
variable btetramer8 equal f_freact[88]
variable btetramer9 equal f_freact[89]
variable btetramer10 equal f_freact[90]
variable btetramer11 equal f_freact[91]
variable btetramer12 equal f_freact[92]
variable btetramer13 equal f_freact[93]


fix		fix_printM all print ${thermodump} "${vrdimer} ${vrdimer1} ${vrdimer2} ${vrdimer3} ${vrtrimer} ${vrtrimer1} ${vrtrimer2} ${vrtrimer3} ${vrtrimer4} ${vrtrimer5} ${vrtrimer6} ${vrtrimer7} ${vrtrimer8} ${vrtrimer9} ${vrtrimer10} ${vrtrimer11} ${vrtrimer12} ${vrtrimer13} ${vrtrimerF1} ${vrtrimerF2} ${vrtrimerF3} ${vrtrimerF4} ${vrtrimerF5} ${vrtrimerF6} ${vtetramer0} ${vtetramer1} ${vtetramer2} ${vtetramer3} ${vtetramer4} ${vtetramer5} ${vtetramer6} ${vtetramer7} ${vtetramer8} ${vtetramer9} ${vtetramer10} ${vtetramer11} ${vtetramer12} ${vtetramer13} ${vtetramer14} ${vtetramer15} ${vtetramer16} ${vtetramer17} ${vtetramer18} ${vtetramer19} ${vtetramer20} ${vtetramer21} ${vtetramer22} ${vtetramer23} ${vtetramer24}" file reactionsMake.dat screen no title "2bonded-3_0 2bonded-3_1 2bonded-3_2 2bonded-3_3 23bonded-4_0 23bonded-4_1 23bonded-4_2 23bonded-4_3 23bonded-4_4 23bonded-4_5 23bonded-4_6 23bonded-4_7 23bonded-4_8 23bonded-4_9 23bonded-4_10 23bonded-4_11 23bonded-4_12 23bonded-4_13 4bonded-5_1 4bonded-5_2 4bonded-5_3 4bonded-5_4 4bonded-5_5 4bonded-5_6 52bonded-6_0 52bonded-6_1 52bonded-6_2 52bonded-6_3 52bonded-6_4 52bonded-6_5 52bonded-6_6 52bonded-6_7 52bonded-6_8 52bonded-6_9 52bonded-6_10 52bonded-6_11 52bonded-6_12 52bonded-6_13 52bonded-6_14 52bonded-6_15 52bonded-6_16 52bonded-6_17 52bonded-6_18 52bonded-6_19 52bonded-6_20 52bonded-6_21 52bonded-6_22 52bonded-6_23 52bonded-6_24"


fix		fix_printB all print ${thermodump} "${bdimer} ${bdimer2} ${bdimer6} ${bdimer62} ${bdimer4} ${bdimer42} ${bdimer5} ${bdimer52} ${bdimer7} ${bdimer72} ${bdimerA} ${bdimerA1} ${bdimerA2} ${bdimerA3} ${btrimer} ${btrimer1} ${btrimer2} ${btrimer3} ${btrimer4} ${btrimer5} ${btrimerF} ${btrimerF1} ${btrimerF2} ${btrimerF3} ${btrimerF4} ${btrimerF5} ${btrimerF6} ${btrimerF7} ${btrimerF8} ${btrimerF9} ${btetramer} ${btetramer1} ${btetramer2} ${btetramer3} ${btetramer4} ${btetramer5} ${btetramer6} ${btetramer7} ${btetramer8} ${btetramer9} ${btetramer10} ${btetramer11} ${btetramer12} ${btetramer13}" file reactionsBreak.dat screen no title "3unbonded-2_1 3unbonded-2_2 6unbonded-2_1 6unbonded-2_2 4unbonded-2_1 4unbonded-2_2 5unbonded-2_1 5unbonded-2_2 7unbonded-2_1 7unbonded-2_2 4unbonded-3_0 4unbonded-3_1 4unbonded-3_2 4unbonded-3_3 6unbonded-5_0 6unbonded-5_1 6unbonded-5_2 6unbonded-5_3 6unbonded-5_4 6unbonded-5_5 5unbonded-4_0 5unbonded-4_1 5unbonded-4_2 5unbonded-4_3 5unbonded-4_4 5unbonded-4_5 5unbonded-4_6 5unbonded-4_7 5unbonded-4_8 5unbonded-4_9 7to6_0 7to6_1 7to6_2 7to6_3 7to6_4 7to6_5 7to6_6 7to6_7 7to6_8 7to6_9 7to6_10 7to6_11 7to6_12 7to6_13"
...
fix 		fix_bonds_nc1 	nc1 bond/create  ${nevery_Cr} 1 1 ${cutoff} 2 iparam ${max_bonds_nc1} 1 jparam ${max_bonds_nc1} 1 prob ${prob} 49829 atype 1 equilib ${r0_nc1} ${k_nc1} ${ChemBond}
fix 		fix_bonds_7s	7s 	bond/create  ${nevery_Cr} 2 2 ${cutoff} 3 iparam ${max_bonds_7s} 7 jparam ${max_bonds_7s} 7 prob ${prob} 29829 atype 2 equilib ${r0_7s} ${k_7s} ${ChemBond}
fix 		fix_bonds_7s_2	7s bond/create  ${nevery_Cr} 2 3 ${cutoff} 3 iparam ${max_bonds_7s} 7 jparam ${max_bonds_7s} 7 prob ${prob} 29829 atype 2 equilib ${r0_7s} ${k_7s} ${ChemBond}
fix 		fix_bonds_7s_3	7s bond/create ${nevery_Cr2} 4 4 ${cutoff} 3 iparam ${max_bonds_7s} 7 jparam ${max_bonds_7s} 7 prob ${prob} 29829 atype 2 equilib ${r0_7s} ${k_7s} ${ChemBond}
fix 		fix_bonds_7s_4	7s bond/create  ${nevery_Cr} 2 5 ${cutoff} 3 iparam ${max_bonds_7s} 2 jparam ${max_bonds_7s} 5 prob ${prob} 29829 atype 2 equilib ${r0_7s} ${k_7s} ${ChemBond}
fix 		fix_bonds_7s_5	7s bond/create  ${nevery_Cr2} 6 6 ${cutoff} 3 iparam ${max_bonds_7s} 6 jparam ${max_bonds_7s} 6 prob ${prob} 29829 atype 2 equilib ${r0_7s} ${k_7s} ${ChemBond}
...
fix 		fix_bonds_break_nc1 	nc1 bond/break  ${nevery_Br} 2 0.0 prob ${prob} 49829 equilib ${r0_nc1} ${k_nc1} ${ChemBond}
fix 		fix_bonds_break_7s 	7s bond/break  ${nevery_Br} 3 0.0 prob ${prob} 49825 equilib ${r0_7s} ${k_7s} ${ChemBond}
