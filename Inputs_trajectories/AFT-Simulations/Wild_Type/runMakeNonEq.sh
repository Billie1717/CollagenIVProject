...
for XStretch in 350 
do
foldernameadd='runs/runRestart_tmix'${t_mix}'_tbonds'${t_bonds}'_tstretch'${t_stretch}'_trelax'${t_relax}'_N_fix'${NBM_Cyc}'_XStretch'${XStretch}'_Nev'${Nevery}'_MP'${MakeProb}'_BP'${BreakProb}'_MD'${MakeDist}'_BD'${BreakDist}'_seed'${seed}
mkdir ${foldernameadd}
input='data'
